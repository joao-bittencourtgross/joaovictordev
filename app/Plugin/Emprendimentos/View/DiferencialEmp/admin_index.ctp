        ...
        <div class="table-responsive">
            <table class="mb-0 table">
                ...
                <tbody class="sortable">
                    ...
                    ?>
                        <tr data-id="<?PHP echo $post['DiferencialEmp']['id']; ?>">
                            <td><?PHP echo $post['DiferencialEmp']['title']?></td>
                            <td><?PHP echo $post['Emprendimento']['title']?></td>
                            <td><?PHP echo $this->Locker->link('Opções',array('plugin'=>'emprendimentos','controller'=>'diferencial_emp_opc','action'=>'admin_index',$post['DiferencialEmp']['id']),array('class'=>'btn-edit btn-pink'))?></td>
                            <td><?PHP echo $this->Locker->link('Editar',array('action'=>'admin_edit',$post['DiferencialEmp']['id']),array('class'=>'btn-edit'))?></td>
                            <td><?PHP echo $this->Locker->link('Excluir',array('action'=>'admin_delete',$post['DiferencialEmp']['id']),array('class'=>'btn-remove'),'Tem certeza?')?></td>
                        </tr>
                    <?PHP 
                        } 
                    ?>
