        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="col-md-12">
                        <?PHP 
                          //  $categorias = array('Filme Polietileno'=>'Filme Polietileno', 'Sacos e Folhas Plásticas'=>'Sacos e Folhas Plásticas', 'Fios Poliéster'=>'Fios Poliéster', 'Vestimentas Descartáveis'=>'Vestimentas Descartáveis');
