    ...
    <fieldset class="box image file" data-name="<?=$name?>">
        <?PHP
            if($param1 && $param2 && $param3){
                echo $this->Html->link('<span class="delete_image" title="Excluir Imagen?">X</span>',array('plugin'=>'painel','controller'=>'uploads','action'=>'delete_img',$param1,$param2,$param3),array('escape'=>false),'Excluir Imagen?');
            }
            
            echo $this->Form->input("$name-picker",array('type'=>'file','label'=>'Selecione uma imagem','data-extensions'=>'jpg,jpeg,png,gif','data-maxsize'=>8000,'reduce'=>$reduce));
            echo '<br><br>';
